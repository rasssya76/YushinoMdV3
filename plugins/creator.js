...
let name = await conn.getName(who)
 ...
 const ini = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `I'M DEVELOPER `, `Don't call me`, `⁨https://kyoumasa@gmail.com`, `🇮🇩 Indonesia`, `https://youtube.com/c/RamaGans`, `nothing`], fkontak)
